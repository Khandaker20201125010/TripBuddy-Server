...
class IPGeolocationService {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const api of this.APIs) {
                try {
                    ...
                    const result = yield this.fetchFromAPI(url, api.name);
                    ...
                    if (parsed.success) {
                        ...
                        if (this.isValidCoordinates(parsed.latitude, parsed.longitude)) {
                            return Object.assign(Object.assign({}, parsed), { ip, source: parsed.source });
                        }
                        else {
    ...
    static fetchFromAPI(url, apiName) {
        return __awaiter(this, void 0, void 0, function* () {
...
IPGeolocationService.APIs = [
    {
        ...
        parse: (data, ip) => {
            ...
            return ({
                ...
                countryCode: (_a = data.country_code) === null || _a === void 0 ? void 0 : _a.toUpperCase(),
                region: data.region,
    ...
    },
    {
        ...
        parse: (data, ip) => {
            ...
            return ({
                ...
                countryCode: (_a = data.country_code) === null || _a === void 0 ? void 0 : _a.toUpperCase(),
                region: data.region,
                timezone: (_b = data.timezone) === null || _b === void 0 ? void 0 : _b.id,
                isp: (_c = data.connection) === null || _c === void 0 ? void 0 : _c.isp,
                source: 'ipwhois'
            });
        }
    },
    {
        ...
        parse: (data, ip) => {
            ...
            return ({
                ...
                countryCode: (_a = data.geoplugin_countryCode) === null || _a === void 0 ? void 0 : _a.toUpperCase(),
